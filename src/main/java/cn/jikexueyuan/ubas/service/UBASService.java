...
public class UBASService {
	...
	public interface AsyncIface {
		...
		public void queryDayKPI(String beginDate, String endDate,
				org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

		public void queryHourKPI(String beginDate, String endDate,
				org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
	...
	public static class Client extends org.apache.thrift.TServiceClient implements Iface {
		...
		public Map<Double, Double> recv_queryHourKPI() throws org.apache.thrift.TException {
			...
			throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT,
					"queryHourKPI failed: unknown result");
		}
	...
	public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
		...
		public void queryDayKPI(String beginDate, String endDate,
				org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
			checkReady();
			queryDayKPI_call method_call = new queryDayKPI_call(beginDate, endDate, resultHandler, this,
		...
		public static class queryDayKPI_call extends org.apache.thrift.async.TAsyncMethodCall {
			...
			public queryDayKPI_call(String beginDate, String endDate,
		...
		public void queryHourKPI(String beginDate, String endDate,
				org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
			checkReady();
			queryHourKPI_call method_call = new queryHourKPI_call(beginDate, endDate, resultHandler, this,
					___protocolFactory, ___transport);
			this.___currentMethod = method_call;
			___manager.call(method_call);
		}
		...
		public static class queryHourKPI_call extends org.apache.thrift.async.TAsyncMethodCall {
			...
			public queryHourKPI_call(String beginDate, String endDate,
					org.apache.thrift.async.AsyncMethodCallback resultHandler,
					org.apache.thrift.async.TAsyncClient client,
					org.apache.thrift.protocol.TProtocolFactory protocolFactory,
					org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
			...
			public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
				prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("queryHourKPI",
						org.apache.thrift.protocol.TMessageType.CALL, 0));
				queryHourKPI_args args = new queryHourKPI_args();
				args.setBeginDate(beginDate);
				args.setEndDate(endDate);
	...
	public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I>
		...
		public static class queryDayKPI<I extends Iface>
				extends org.apache.thrift.ProcessFunction<I, queryDayKPI_args> {
			public queryDayKPI() {
				super("queryDayKPI");
			}
		...
		public static class queryHourKPI<I extends Iface>
				extends org.apache.thrift.ProcessFunction<I, queryHourKPI_args> {
			public queryHourKPI() {
				super("queryHourKPI");
			}
	...
	public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
		...
		public static class queryDayKPI<I extends AsyncIface>
				extends org.apache.thrift.AsyncProcessFunction<I, queryDayKPI_args, Map<String, Double>> {
			public queryDayKPI() {
				super("queryDayKPI");
			}
			...
			public AsyncMethodCallback<Map<String, Double>> getResultHandler(final AsyncFrameBuffer fb,
					final int seqid) {
			...
			public void start(I iface, queryDayKPI_args args,
					org.apache.thrift.async.AsyncMethodCallback<Map<String, Double>> resultHandler) throws TException {
				iface.queryDayKPI(args.beginDate, args.endDate, resultHandler);
			}
		}

		public static class queryHourKPI<I extends AsyncIface>
				extends org.apache.thrift.AsyncProcessFunction<I, queryHourKPI_args, Map<Double, Double>> {
			public queryHourKPI() {
				super("queryHourKPI");
			}
			...
			public AsyncMethodCallback<Map<Double, Double>> getResultHandler(final AsyncFrameBuffer fb,
					final int seqid) {
				final org.apache.thrift.AsyncProcessFunction fcall = this;
			...
			public void start(I iface, queryHourKPI_args args,
					org.apache.thrift.async.AsyncMethodCallback<Map<Double, Double>> resultHandler) throws TException {
	...
	public static class queryDayKPI_args implements org.apache.thrift.TBase<queryDayKPI_args, queryDayKPI_args._Fields>,
			java.io.Serializable, Cloneable, Comparable<queryDayKPI_args> {
		...
		public enum _Fields implements org.apache.thrift.TFieldIdEnum {
			BEGIN_DATE((short) 1, "beginDate"), END_DATE((short) 2, "endDate");
		...
		public queryDayKPI_args(String beginDate, String endDate) {
			this();
			this.beginDate = beginDate;
			this.endDate = endDate;
		}
	...
	public static class queryDayKPI_result
			implements org.apache.thrift.TBase<queryDayKPI_result, queryDayKPI_result._Fields>, java.io.Serializable,
			Cloneable, Comparable<queryDayKPI_result> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"queryDayKPI_result");
		...
		public queryDayKPI_result(Map<String, Double> success) {
			this();
	...
	public static class queryHourKPI_args
			implements org.apache.thrift.TBase<queryHourKPI_args, queryHourKPI_args._Fields>, java.io.Serializable,
			Cloneable, Comparable<queryHourKPI_args> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"queryHourKPI_args");
		...
		public queryHourKPI_args(String beginDate, String endDate) {
			this();
			this.beginDate = beginDate;
			this.endDate = endDate;
		}
		...
		private static class queryHourKPI_argsStandardScheme extends StandardScheme<queryHourKPI_args> {
			...
			public void read(org.apache.thrift.protocol.TProtocol iprot, queryHourKPI_args struct)
					throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
			...
			public void write(org.apache.thrift.protocol.TProtocol oprot, queryHourKPI_args struct)
					throws org.apache.thrift.TException {
				struct.validate();
		...
		private static class queryHourKPI_argsTupleScheme extends TupleScheme<queryHourKPI_args> {
			...
			public void write(org.apache.thrift.protocol.TProtocol prot, queryHourKPI_args struct)
					throws org.apache.thrift.TException {
				TTupleProtocol oprot = (TTupleProtocol) prot;
				BitSet optionals = new BitSet();
				if (struct.isSetBeginDate()) {
			...
			public void read(org.apache.thrift.protocol.TProtocol prot, queryHourKPI_args struct)
					throws org.apache.thrift.TException {
				TTupleProtocol iprot = (TTupleProtocol) prot;
				BitSet incoming = iprot.readBitSet(2);
				if (incoming.get(0)) {
	...
	public static class queryHourKPI_result
			implements org.apache.thrift.TBase<queryHourKPI_result, queryHourKPI_result._Fields>, java.io.Serializable,
			Cloneable, Comparable<queryHourKPI_result> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"queryHourKPI_result");
		...
		public queryHourKPI_result(Map<Double, Double> success) {
			this();
			this.success = success;
		}
		...
		private static class queryHourKPI_resultStandardScheme extends StandardScheme<queryHourKPI_result> {
			...
			public void read(org.apache.thrift.protocol.TProtocol iprot, queryHourKPI_result struct)
					throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
			...
			public void write(org.apache.thrift.protocol.TProtocol oprot, queryHourKPI_result struct)
					throws org.apache.thrift.TException {
				struct.validate();
		...
		private static class queryHourKPI_resultTupleScheme extends TupleScheme<queryHourKPI_result> {
			...
			public void write(org.apache.thrift.protocol.TProtocol prot, queryHourKPI_result struct)
					throws org.apache.thrift.TException {
				TTupleProtocol oprot = (TTupleProtocol) prot;
				BitSet optionals = new BitSet();
				if (struct.isSetSuccess()) {
			...
			public void read(org.apache.thrift.protocol.TProtocol prot, queryHourKPI_result struct)
					throws org.apache.thrift.TException {
				TTupleProtocol iprot = (TTupleProtocol) prot;
				BitSet incoming = iprot.readBitSet(1);
				if (incoming.get(0)) {
